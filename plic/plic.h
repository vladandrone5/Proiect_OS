...
#define PLIC_ADDR (u32)0xC000000
...
void reset_plic_source_pry_trsh(u32 ctx_addr); // reset plic source priority treshold
void set_plic_source_pry_trsh(u32 ctx_addr,u32 priority) // set plic source priority treshold
u32 claim_plic_int_msg(u32 ctx_addr); // read msg/id from claim/complete reg to get biggets priority interrupt ID
